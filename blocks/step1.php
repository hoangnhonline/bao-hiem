                        ...
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body">
                            <div class="col-md-12">
                              ...
                              <div class="col-md-12" id="hinh-thuc">
                              ...
                              <div class="col-md-12" id="lua-chon">
                                ...
                                <div class="col-md-12" style="text-align:right">
                                  <button class="btn-warning btn" id="btnXemphi">Xem phi</button>
                                </div>
                                
                              </div>
                          </div>
                          <div class="clearfix" style="margin-bottom:20px;"></div>
                          <div class="title">Cách thức mua bảo hiểm</div>
                            <div class="col-md-12">
                              <ul>
                                <li>1. Trực tiếp lên website nhanh nhất - tiện nhất</li>
                                <li>2. Gọi vào Hotline:0983.787.787 - 0987.520.520</li>
                                <li>3. Qua chat:</li>
                                <li>4. Đến trực tiếp đại lý Én Việt trên toàn quốc</li>
                              </ul>
                            </div>
                        </div><!--col-md-6-->